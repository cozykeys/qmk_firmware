...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_GRV,  MO(_FN), KC_BSPC, KC_DEL,  KC_DOWN, KC_ENT,    KC_SPC,  MO(_FN), KC_MENU, KC_RALT, KC_RGUI, KC_RCTL
    ),
    [_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_M_P, RGB_M_B, _______, _______, _______, _______, _______, _______,
