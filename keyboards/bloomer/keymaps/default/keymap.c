...
[DEFAULT] = LAYOUT(
    ...
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_PGUP,     KC_SLCK, TG(NUM),      KC_HOME, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
...
[FN] = LAYOUT(
    ...
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______,     RGB_N,   RGB_P,        _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
